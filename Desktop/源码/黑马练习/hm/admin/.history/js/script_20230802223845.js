$(function() {
    ...
    layui.use(function() {
        ...
        form.on('submit(demo-login)', function(data) {
            /* eslint-disable */console.log(...oo_oo(`52541650_0`,data))
            var field = data.field; // 获取表单字段值
            /* eslint-disable */console.log(...oo_oo(`52541650_1`,field))
                // 显示填写结果，仅作演示用
            ...
            if (val == '') {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        /* eslint-disable */console.log(...oo_oo(`52541650_2`,res.msg))

                        if (res.code === 400 && res.msg === '密码错误' || res.msg === '用户不存在' || res.msg === '账号已被禁用') { //判断密码错误
                            layer.msg(res.msg);
                        } else {
                            layer.msg(res.msg);
                            /* eslint-disable */console.log(...oo_oo(`52541650_3`,'创建了本地存储'))
    ...
    (function() {
        ...
        layui.use(function() {
            ...
            form.on('submit(demo-reset-submit)', function(data) {
                /* eslint-disable */console.log(...oo_oo(`52541650_4`,data))
                var field = data.field; // 获取表单字段值
                /* eslint-disable */console.log(...oo_oo(`52541650_5`,field))
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        /* eslint-disable */console.log(...oo_oo(`52541650_6`,res.msg))
                        layer.msg(res.msg)
                    }
        ...
        /* eslint-disable */console.log(...oo_oo(`52541650_7`,111))
    }())
    // 找回密码-------------------------------------------
    ...
    layui.use(function() {
        ...
        $('#obtain-code').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    /* eslint-disable */console.log(...oo_oo(`52541650_8`,res.msg, res))
                    layer.msg(res.msg)
                        // 判断发送成功则开启倒计时，期间不能点击
                    if (res.code === 200 && res.msg === '注册成功') {
                        /* eslint-disable */console.log(...oo_oo(`52541650_9`,'注册成功'))
                            //发送成功事件
                            // var minute = 5;
                            // // 每隔一秒执行一次
                            // items = setInterval(function() {
        ...
        form.on('submit(demo-reg)', function(data) {
            var field = data.field; // 获取表单字段值
            /* eslint-disable */console.log(...oo_oo(`52541650_10`,field.username, field.password, field.useremail, field.code))
                // 是否勾选同意
                // if (!field.agreement) {
            ...
            // 此处可执行 Ajax 等操作
            var formdata = $('#reg-form').serialize();
            /* eslint-disable */console.log(...oo_oo(`52541650_11`,formdata))
            $.ajax({
                type: 'GET',
                url: 'v1/Register',
                ...
                success: function(res) {
                    /* eslint-disable */console.log(...oo_oo(`52541650_12`,res))
                    if (res.code === 200 && res.msg === '注册成功') {
                        /* eslint-disable */console.log(...oo_oo(`52541650_13`,'注册成功'))
                    } else if (res.code === 400 && res.msg === '用户已存在') {
                        /* eslint-disable */console.log(...oo_oo(`52541650_14`,'用户已存在'))
                    } else if (res.code === 400 && res.msg === '邮箱已存在') {
                        /* eslint-disable */console.log(...oo_oo(`52541650_15`,'邮箱已存在'))
                    }
                }
            })
    ...
    function login() {
        ...
        /* eslint-disable */console.log(...oo_oo(`52541650_16`,a))
        $.ajax({
            type: "GET",
            url: 'v1/Login',
            data: {
            ...
            success: function(res) {
                /* eslint-disable */console.log(...oo_oo(`52541650_17`,res))
            }
        })
